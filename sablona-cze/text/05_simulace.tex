...
Simulátory umožňují letovému kódu PX4 ovládat počítačem namodelovaný dron v simulovaném \uv{světě}. S tímto dronem je možné komunikovat stejně jako se skutečným dronem pomocí QGroundControl, offboard API nebo rádiového ovladače/gamepadu. 
